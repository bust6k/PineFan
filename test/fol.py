...
for bar in close:
    foo = 4
    color    i_phl_1_h_ln_color =     0x558ef5cd99d0(0)

    int    a = 5
    color    i_phl_1_h_ln_color =     0x558ef5cd9f90(0)

    idf    # in source code version that was switch-statement. Since Python doesn't it(but only since Python 3.10),PineFan
